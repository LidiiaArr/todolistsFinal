...
export const auth = {
    ...
    login(data: FormType) {
        ...
        //метод post для отправки логина и пароля
        //первый параметр игнорируется если указан второй
        //AxiosResponse<ResponseType<{ userId: number }>> то что возвращает бекенд
